...
# 1. Load & Resample to Daily
# Replace line 14 in src/model.py with this:
df = pd.read_csv("data/cleaned_steel.csv", parse_dates=["Date"], engine="python", on_bad_lines="skip")
